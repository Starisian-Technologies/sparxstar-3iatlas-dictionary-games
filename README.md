...
*production* games and contribute to the learner's "words you can write" count.
...
`/wordlist` requires a consumer API key; sending an ephemeral page token returns
403. See `src/api/dictionary-api.d.ts` for the full type contract.
